...
namespace SSMO.Services.Documents.Purchase
{
    public interface IPurchaseService
    {
        ...
        public Task<bool> CreatePurchaseAsPerSupplierOrder(int id,
            ...
            string incoterms, string deliveryAddress, string loadingAddress,
            string shippingLine, string eta, bool delayCostCalc, int costPriceCurrencyId,string origin);
        ...
        public Task<bool> EditPurchaseInvoice(int id, string number,DateTime date, int supplierOrderId, 
            int vat, int currency, decimal netWeight, decimal grossWeight, string truckNumber, 
            string swb, decimal purchaseTransportCost,decimal bankExpenses, decimal duty, 
            decimal customsExpenses, decimal factoring, decimal fiscalAgentExpenses,decimal procentComission, 
            decimal otherExpenses, List<PurchaseProductsForEditFormModel> purchaseProducts,
            string deliveryAddress, string shippingLine, string eta, int costPriceCurrencyId, 
            bool delayCostCalc, string origin, string customsDeclaration);
