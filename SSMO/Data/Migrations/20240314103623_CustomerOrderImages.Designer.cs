...
namespace SSMO.Data.Migrations
{
    ...
    [Migration("20240314103623_CustomerOrderImages")]
    partial class CustomerOrderImages
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SSMO.Data.Models.Document", b =>
                {
                    ...
                    b.Property<string>("CustomsExportDeclaration")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("CustomsImportDeclaration")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("SSMO.Data.Models.FscText", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SSMO.Data.Models.InvoiceProductDetails", b =>
                {
                    ...
                    b.Property<int?>("CreditNoteTotalSheets")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("DebitNoteTotalSheets")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SSMO.Data.Models.Payment", b =>
                {
                    ...
                    b.Property<int?>("CurrencyForCalculationsId")
                        .HasColumnType("int");
                    ...
                    b.Property<decimal?>("NewAmountPerExchangeRate")
                        .HasPrecision(18, 6)
                        .HasColumnType("decimal(18,6)");
            ...
            modelBuilder.Entity("SSMO.Data.Models.TransportCompany", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SSMO.Data.Models.Payment", b =>
                {
                    b.HasOne("SSMO.Data.Models.Currency", "CurrencyForCalculations")
                        .WithMany("PaymentsWithExchangeRate")
                        .HasForeignKey("CurrencyForCalculationsId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.HasOne("SSMO.Data.Models.ServiceOrder", "ServiceOrder")
                        .WithMany("Payments")
                    ...
                    b.Navigation("CurrencyForCalculations");
            ...
            modelBuilder.Entity("SSMO.Data.Models.ServiceOrder", b =>
                {
                    ...
                    b.HasOne("SSMO.Data.Models.Document", null)
                        ...
                        .HasForeignKey("SSMO.Data.Models.ServiceOrder", "DocumentId1");
                    ...
                    b.HasOne("SSMO.Data.Models.TransportCompany", "TransportCompany")
                        .WithMany("ServiceOrders")
            ...
            modelBuilder.Entity("SSMO.Data.Models.TransportCompany", b =>
                {
                    b.HasOne("SSMO.Data.Models.Address", "Address")
                        ...
                        .HasForeignKey("SSMO.Data.Models.TransportCompany", "AddressId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("SSMO.Data.Models.Image", b =>
                {
                    b.Navigation("CustomerOrdersFooter");

                    b.Navigation("CustomerOrdersHeader");
